  ...
  <div class="container mx-auto py-4">
    ...
    <div class="flex flex-col w-full">
      ...
      <div class="navbar gap-3 flex-wrap justify-center  bg-base-300 rounded-box">
        <div class="dropdown dropdown-end">
          упорядочить по:&#x2000;
          <label tabindex="0" class="btn w-28 btn-secondary rounded-btn">{{ btnToggle ? "Городам" : "Профилям" }}</label>
        ...
        <div>
          сортировать по:&#x2000;
          <button class="btn btn-secondary w-28 ml-[7px] md:ml-0" @click="sortList">
    ...
    <div id="cards" class="mt-4 flex flex-wrap gap-4 md:gap-2 justify-center">
      <div id="singleCard" v-for="(vuz, index) in pagCards"
        class="card card-compact w-[15rem] 2xl:w-72  bg-base-100 shadow-xl mt-4 sm:mt-0" :key="vuz">
        <figure>
